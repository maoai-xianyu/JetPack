...
import com.mao.jetpack.databinding.FragmentNvThreeBinding
 ...
 * @Description
 */
class FragmentNVThree : Fragment() {

    private var binding: FragmentNvThreeBinding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentNvThreeBinding.inflate(inflater, container, false)
        return binding?.root
