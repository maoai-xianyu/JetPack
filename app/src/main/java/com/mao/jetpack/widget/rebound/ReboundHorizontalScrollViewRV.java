...
public class ReboundHorizontalScrollViewRV extends HorizontalScrollView {

    private View inner;

    public ReboundHorizontalScrollViewRV(Context context) {
        this(context, null);
    }

    public ReboundHorizontalScrollViewRV(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReboundHorizontalScrollViewRV(Context context, AttributeSet attrs, int defStyleAttr) {
